...
const Contact = () => {
    return (
      <section id='Contact' className='w-full'>
        ...
        <div className='flex max-lg:px-1 lg:flex-row max-lg:flex-col px-7 max-lg:gap-16 lg:gap-32 mt-20'>
         <a href='mailto:alirezaghaffar.dev@gmail.com' className='flex max-lg:justify-center max-lg:gap-4 gap-7 items-center'>
        ...
        <div className='flex max-lg:justify-center max-lg:gap-4 gap-7 items-center'>
        <div className='shadow-lg p-2 rounded-full'>
        <svg
            width="30" height="30" 
            viewBox="0 0 24 24" 
